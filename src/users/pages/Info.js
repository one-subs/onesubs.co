        ...
        <div className="user">
            <div className="page_width">
                <div className="left">
                    ...
                    <p><Link style={{ textDecorationColor: "#2174ea" }} to="https://forms.gle/PpahrnMJgXYCADAy7"><b style={{ color: "#2174ea" }}>Click here and write your favourite services, and we will request them to collaborate with OneSubs.</b></Link></p>
                </div>
                <div className="right">
